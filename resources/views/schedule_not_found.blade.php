        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 my-5 text-center">
                    ...
                    <h1 class="text-center mt-5" id="errorTitle">Schedule Not Found</h1>

                    <h5 id="errorMessage">
                        Schedule only available max 2 days before departure. Please contact admin for other schedules.
                    </h5>
