                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="vehicle" name="vehicle" required>
                                            ...
                                            @foreach($vehicle as $item)
                                                @if($item->vehicle_number === $charters->vehicle_number)
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vehicle_name" name="vehicle_name"
                                            value="{{ $charters->vehicle_name }}" minlength="3" disabled />
                                    </div>
                                    <div class="form-group">
                                        <label for="vehicle_number">Vehicle Number</label>
                                        <input type="text" class="form-control" id="vehicle_number" name="vehicle_number"
                                            value="{{ $charters->vehicle_number }}" minlength="3" disabled />
                                    </div>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="total_seat" name="total_seat"
                                            value="{{ $charters->total_seat }}" min="1" max="99" disabled/>
                                    </div>
