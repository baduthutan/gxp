                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                @csrf
                                <form action="{{ route('admin.bookingreportcharterbyarea.index') }}" method="GET"
                                    id="filter-form">
                                    <div class="row">
                                    ...
                                    <table class="table table-bordered datatables">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="min-width: 100px;">Vehicle type & Number</th>
                                        ...
                                        <tbody>
                                            @foreach ($bookings as $booking)
                                                <tr>
                                                    ...
                                                    <td>{{ $booking->vehicle_name }} {{ $booking->vehicle_number? ' |
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#export-xlx').on('click', function(e) {
                e.preventDefault();
                window.open('{{ url('/admin/bookingreportcharterbyarea') }}' + '/export_xlx?' + form_filter
                    .serialize(),
                    '_blank')
            })
