...
class BookingCharterByAreaReport extends DefaultValueBinder implements WithCustomValueBinder, FromView, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('exports.booking_charter_by_area', [
            'data' => $data,
        ]);
    }
