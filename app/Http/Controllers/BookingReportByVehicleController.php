...
class BookingReportByVehicleController extends Controller
{
    public function index(BookingReportByVehicleRequest $request)
    {
        ...
        $data = [
            'page_title' => 'BOOKING REPORT SHUTTLE FILTERED BY VEHICLE',
        ...
        return view('admin.bookingreportbyvehicle.index', $data);
    }
